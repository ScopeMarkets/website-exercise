        ...
        <div className="flex flex-col desktop:flex-row items-center">
          <div className="desktop:basis-7/12">
            <div className="desktop:my-36 my-20 flex items-center">
              ...
              <h1 className="desktop:text-8xl text-5xl font-bold">Rostro’s Social Responsibility</h1>
            </div>
            <div className="desktop:w-5/6">
              <h2 className="desktop:text-6xl text-3xl font-bold desktop:mb-12 mb-8">The Rostro Philosophy</h2>
              <h3 className="text-3xl mb-8">
                A gateway for financial inclusion; we believe in financial well-being for all.
              </h3>
              <div className="space-y-8 text-blue-3  desktop:mb-24">
                <p>
          ...
          <Image className="mx-auto self-end" src="/images/page-1/hands.png" alt="Giving" width={650} height={381} />
        </div>
      </div>
    </div>
  );
